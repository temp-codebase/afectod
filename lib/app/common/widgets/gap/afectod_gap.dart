import 'package:afectod/app/common/widgets/gap/render_gap.dart';
...
class AfectodGap extends StatelessWidget {
  ...
  ///
  /// The [mainAxisExtent] must not be null and must be positive.
  const AfectodGap.expand(double mainAxisExtent, {Key? key, Color? color})
    : this(
        mainAxisExtent,
        key: key,
  ...
  static const AfectodGap xs = AfectodGap(4);
  static const AfectodGap s = AfectodGap(8);
  static const AfectodGap m = AfectodGap(16);
  static const AfectodGap l = AfectodGap(24);
  static const AfectodGap xl = AfectodGap(32);
  static const AfectodGap xxl = AfectodGap(48);
